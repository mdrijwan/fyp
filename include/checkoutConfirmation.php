    ...
    <table width="550" border="0" align="center" cellpadding="10" cellspacing="0">
        ...
        <tr> 
            <td><p>After you click on  &quot;Confirm Order&quot; button below, 
                    ...
                    <br>
                    <br>
                    Email : sales@musicalholicone.com <br>
...
?>
        ...
        <tr > 
            <td colspan="2" align="right">3% Service Charge</td>
        ...
        <tr > 
            <td colspan="2" align="right"><table width="100%" ><tr><td align="left"><?php echo displayWeight($subTotal1); ?> </td><td align="right"><font size="-1">Shipping</font></td></tr></table></td>
...
<input name="hidShippingAmount" type="hidden" id="hidShippingAmount" value="<?php $shippingamount1=displayAmountOnly($total_shipping_price);echo $shippingamount1  ?>">
    ...
    <table width="550" border="0" align="center" cellpadding="5" cellspacing="1" class="infoTable">
      <tr>
       ...
       <tr><td>  <img src="slide/images/paypallogo1.jpg" /></td><td><!--<img src="slide/images/cardtype.jpg" />--></td> </tr>
