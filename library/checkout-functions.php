...
$hidShippingCountry       = ucfirst($lowhidShippingCountry);		
		...
		$sql = "INSERT INTO tbl_order(od_date, od_last_update,od_email, od_shipping_first_name, od_shipping_last_name, od_shipping_address1,
		                              od_shipping_address2, od_shipping_phone, od_shipping_state, od_shipping_city, od_shipping_postal_code,od_shipping_country, od_shipping_cost,od_servicecharge,od_shippingtoshop,od_subtotal,od_totalamount,
                ...
                VALUES (NOW(), NOW(),'$hidEmail', '$hidShippingFirstName', '$hidShippingLastName', '$hidShippingAddress1', 
				        '$hidShippingAddress2', '$hidShippingPhone', '$hidShippingState', '$hidShippingCity', '$hidShippingPostalCode','$hidShippingCountry', '$shippingCost','$shippingCharge','$Shippingfeetoshop','$SubTotal','$TotalAmount',
						'$hidPaymentFirstName', '$hidPaymentLastName', '$hidPaymentAddress1', 
						'$hidPaymentAddress2', '$hidPaymentPhone', '$hidPaymentState', '$hidPaymentCity', '$hidPaymentPostalCode','$hidPaymentCountry')";
		$result = dbQuery($sql);
