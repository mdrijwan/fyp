	...
	<div class="header">
		<div class="header_top">
            ...
            <form method="post" action="searchpage.php" name="searchform"  id="searchform">
				    	<input name="searchDB" type="text" id="searchDB" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Enter Product Name or Keyword';}" value="Search by Product Name or Keyword"><input type="submit" value="SEARCH">
				    </form>
			    </div>
    ...
    <div class="content">
    	<div class="support">
  			<div class="support_desc">
  				...
  				<p><span>24 hours | 7 days a week | 365 days a year &nbsp;&nbsp; We are always listening!</span></p>
  				<p> It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters.There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text.</p>
  			</div>
  				<img src="images/feedback.jpg" alt style="width: 205px" />
  			<div class="clear"></div>
  		</div>
...
<div class="contact-form">
                    ...
                    <div>
                      ...
                      <span><input name="name" type="text" id="name" onBlur="MM_validateForm('name','','R');return document.MM_returnValue" value=""></span>
				    </div>
                    <div>
    						    	<span><label>E-MAIL</label></span>
    						    	<span><input name="email" type="text" id="email" onBlur="MM_validateForm('email','','NisEmail');return document.MM_returnValue" value=""></span>
				    </div>
                    <div>
                      <span><label>MOBILE.NO</label></span>
                      <span><input name="mobile" type="text" id="mobile" onBlur="MM_validateForm('mobile','','NisNum');return document.MM_returnValue" value=""></span>
                    </div>
                    <div>
                      <span><label>SUBJECT</label></span>
                      <span><textarea name="message" id="message" onBlur="MM_validateForm('message','','R');return document.MM_returnValue"> </textarea></span>
                    </div>
                      <tr valign="baseline">
