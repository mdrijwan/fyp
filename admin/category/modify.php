...
<form action="processCategory.php?action=modify&catId=<?php echo $catId; ?>" method="post" enctype="multipart/form-data" name="frmCategory" id="frmCategory">
 <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" class="entryTable">
  <tr> 
   ...
   <td class="content"><input name="txtName" type="text" class="box" id="txtName" value="<?php echo $type_name; ?>" size="30" maxlength="50"></td>
  </tr>
  <tr> 
   <td width="150" class="label">Description</td>
   <td class="content"> <textarea name="mtxDescription" cols="50" rows="4" class="box" id="mtxDescription"><?php echo $type_description; ?></textarea></td>
  </tr>
  <tr> 
...
?>
    <br>
    <img src="<?php echo WEB_ROOT . CATEGORY_IMAGE_DIR . $type_image; ?>"> &nbsp;&nbsp;<a href="javascript:deleteImage(<?php echo $cat_id; ?>);">Delete 
    Image</a> 
    <?php
	}
?>
