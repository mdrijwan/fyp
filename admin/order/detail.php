...
$sql = "SELECT od_date, od_last_update, od_status, od_shipping_first_name, od_shipping_last_name, od_shipping_address1, 
			   ...
			   od_payment_state, od_payment_city , od_payment_postal_code,od_payment_country,
			   od_memo
	    FROM tbl_order 
		WHERE od_id = $orderId";
...
$orderStatus = array('New', 'Paid', 'Shipped', 'Completed','Processing','Cancelled');
$orderOption = '';
...
?>
    ...
    <tr > 
            <td colspan="2" align="right">Shipping Fee to Everblazing Creation</td>
        ...
        <tr > 
            <td colspan="2" align="right">5% Service Charge</td>
...
<table width="550" border="0"  align="center" cellpadding="5" cellspacing="1" class="detailTable">
    ...
    <tr> 
        <td width="150" class="label">Shipping Country</td>
...
<table width="550" border="0"  align="center" cellpadding="5" cellspacing="1" class="detailTable">
    ...
    <tr> 
     ...
     <tr> 
        <td width="150" class="label">Payment Country</td>
        <td class="content"><?php echo $od_payment_country; ?> </td>
    </tr>
