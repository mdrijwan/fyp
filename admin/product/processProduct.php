...
function addProduct()
{
    ...
    $name        = $_POST['txtName'];
	$pd_Code     =$_POST['txtCode'];
	$description = $_POST['txtDescription'];
	
	
	$pd_dimension=$_POST['txtdimension'];
	

	
	
	$pd_spec1=$_POST['txtspec1'];
	$pd_spec2=$_POST['txtspec2'];
	...
	$weight       = str_replace(',', '', (double)$_POST['weight']);
	...
	$sql   = "INSERT INTO product_list (cat_id, pd_name,	pd_code, pd_description, pd_price, pd_qty,pd_weight, pd_image, pd_thumbnail, pd_date,pd_dimension
	...
	,pd_spec2
	          ...
	          VALUES ('$catId', '$name','	$pd_Code', '$description', $price, $qty, $weight, '$mainImage', '$thumbnail', NOW(),
	'$pd_dimension','$pd_spec1','$pd_spec2'
