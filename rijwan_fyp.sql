...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 06, 2016 at 02:49 AM
...
('Md Rijwan Razzaq Matin', 'mrrmmonty@gmail.com', '01139866690', 'Let''s get a straight A on this! ');
...
CREATE TABLE `product_list` (
  ...
  `pd_price` decimal(9,2) NOT NULL COMMENT 'must be greater than 0',
...
(122, 82, 1, 'cdqsl6kmk12e2ntt608n6rk6l1', '2016-12-06 02:38:21', '0.50', 1);
...
CREATE TABLE `tbl_order` (
  ...
  `od_totalamount` decimal(9,2) NOT NULL,
  `od_subtotal` decimal(9,2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
('Rijwan Music Store', 'www.rms.com', '', 'sales@rms.com', '0.00', 5, 'y');
...
(0, 'admin', 'password', NULL, '2016-12-06 02:58:53');
...
--
ALTER TABLE `category_type`
  MODIFY `cat_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;
--
-- AUTO_INCREMENT for table `product_list`
--
ALTER TABLE `product_list`
  MODIFY `pd_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=103;
--
...
--
ALTER TABLE `tbl_cart`
  MODIFY `ct_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=123;
--
